...
const PricingData = [
  {
    ...
    plan: "Basic Plan",
    price: "$39",
    desc: "Perfect for freelancers and small business owners",
    includes: [
      "Up to 3 Members",
      "Unlimited Usage",
  ...
  },
  {
    ...
    plan: "Premium Plan",
    price: "$59",
    desc: "Designed for high-growth companies that demand full-service",
    includes: [
      "Up to 15 Members",
      "Unlimited Usage",
      "Unlimited Drive Storage",
...
const Pricing = () => {
  return (
    <>
      <section className="px-[8%] lg:px-[16%] py-10 lg:py-30" id="pricing">
        <div className="flex flex-col items-center">
          <div className="title text-center w-full lg:w-[50%]">
            <h5 className="syne text-2xl">( PRICING TABLE )</h5>
        ...
        {/**Pricing Card*/}
        <div className="mt-20 md:mt-30 Princing-wrap">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {PricingData.map((plan) => (
              <div
                key={plan.id}
                className="flex bg-white/50 border border-white p-4 shadow-lg flex-col rounded-lg"
              >
                <div className="flex flex-col shadow-lg shadow-gray-300 rounded-2xl overflow-hidden w-full">
                  <div className="p-6 pb-2 bg-white/70 pricing-box">
                    ...
                    <button>
                      <div className="btn bg-white hover:bg-black hover:text-white
                        px-6 py-3 rounded-full mb-5 border border-black/30
