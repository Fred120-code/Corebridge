        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-5">
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-lg syne tracking-wider text-gray-500 my-5">
              On average, we’ve delivered an impressive 780% return on
              investment for our clients. For example, we helped a software
              product company grow their organic traffic tenfold — from 20,000
              to over 200,000 monthly visitors.
            </p>
            <p className="text-lg syne tracking-wider text-gray-500 my-5">
              These results aren’t just exceptions, they’re what happens when
              you invest in sustainable SEO strategies that focus on stable,
              long-term growth.
            </p>
            <button
              className="btn bg-black text-white px-5 py-2 rounded-lg mt-5 border
                         border-black transition-all duration-300 cursor-pointer"
            >
          ...
          <div className="w-full lg:w-1/2">
            <div className="w-full flex justify-center items-center">
              <div
                className="about-info-wrap rounded-2xl bg-white/40 border 
                border-white p-5"
              >
                <div
                  className="about-img-card rounded-2xl bg-white shadow-lg
                 shadow-gray-300 p-6"
                >
                  <div className="about-img">
                    <h2 className="syne text-3xl">Organic search spot</h2>
                    <div className="mt-5">
                      <div
                        className=" inline-block text-3xl p-2 rounded-2xl mt-5 
                      ...
                      >
                        ...
                        />
                        %
                        <span className="text-[15px] ps-1 text-gray-400 syne">
                          AVG
                        </span>
                      </div>
                      <Image src={Chart} alt="Chart" className="mt-5" />
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-40 md:-bottom-10 left-10 lg:-left-20">
                  <div className="w-1/2 rounded-2xl bg-white/50 border border-white p-3">
                    <div className="rounded-2xl bg-white shadow-lg shadow-gray-300 p-5">
                      ...
                      <p className="text-gray-400 tracking-wider syne tex-sm">
                        We plan, manage PPC budget, & measure Google AdWords Pay
                        Per Click
                      </p>
                    </div>
                  </div>
